...
db_name <- 'testdb'
db_host <- 'sqltest.cytsfuy1xubh.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
toy1 <- data.frame(x = seq(1, 30, 1), y = runif(30, 0, 1), z = rnorm(30, 10, 2))
toy2 <- data.frame(x = c(letters, 'aa', 'bb', 'cc', 'dd'), y = rexp(30, 1), z = runif(30, 10, 20))
...
dbGetQuery(mydb, "SELECT y AS 'Random Uniform' FROM toy1 ORDER BY y DESC LIMIT 20;")

#Read the other table according to a condition of one of the variables.
dbGetQuery(mydb, "SELECT * FROM toy2 WHERE z > 15;")
```
...
dbGetQuery(mydb, "INSERT INTO toy1 (x, y) VALUES (100, 50);")
dbGetQuery(mydb, "UPDATE toy2 SET x = 'new' WHERE z > 18;")
dbGetQuery(mydb, "SELECT * FROM toy1;")
dbGetQuery(mydb, "SELECT * FROM toy2;")
dbGetQuery(mydb, "DELETE FROM toy1 WHERE x = 100 AND y = 50;")
dbGetQuery(mydb, "DELETE FROM toy2 WHERE x = 'new';")
dbGetQuery(mydb, "SELECT * FROM toy1;")
dbGetQuery(mydb, "SELECT * FROM toy2;")
```
...
# (will work in SQL, will not work in R)
...
dbGetQuery(mydb,"CREATE TABLE toy1_copy (
  x INTEGER, 
  y INTEGER,
  z INTEGER
  );")
dbListTables(mydb)
dbGetQuery(mydb, "INSERT INTO toy1_copy VALUES ( 1, 2, 3 );")
dbGetQuery(mydb, "INSERT INTO toy1_copy VALUES ( 4, 5, 6 );")
dbGetQuery(mydb, "INSERT INTO toy1_copy VALUES ( 9, 8, 7 );")
dbGetQuery(mydb, "SELECT * FROM toy1_copy;")
dbGetQuery(mydb, "DROP TABLE IF EXISTS toy1_copy;")
dbListTables(mydb)
```
...
#score must be Unique (accepts multiple NULL values)
dbGetQuery(mydb,"CREATE TABLE test2 (
...
dbGetQuery(mydb, "CREATE TABLE toy3 (
           ...
           y INTEGER,
           z INTEGER);")
dbGetQuery(mydb, "INSERT INTO toy3 (y, z) VALUES (33, 84);")
